...
custom_qa = {
    ...
    "how to apply for leave": " Please use the following leeave request form: https://docs.google.com/forms/d/e/1FAIpQLSd1GZ1Rg_7QxOD19Sgm43-OJtfG6TVBfyLo1REIosTLoH4piQ/viewform",
